...
freePort(function(port) {
    ...
    tape('revelations only using server', function(t) {
        t.plan(4)
    ...
    tape('revelations only using server with secondary port', function(t) {
        t.plan(4)
    ...
    tape('revelations only using multiple servers', function(t) {
        t.plan(6)
